          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 9109933507</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Retroclub098@gmail.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <h3 className="font-semibold text-gray-900 mb-4">Bank Information</h3>
                <div className="bg-gray-50 rounded-lg p-4 text-sm">
                  <div className="space-y-2">
                    ...
                    <div><span className="font-medium">Branch:</span> Parasia Road, Chhindwara, Madhya Pradesh</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 text-sm mb-4">
                  We offer free shipping on all orders above ₹999. For orders below ₹999, 
                  shipping charges of ₹50 apply.
                </p>
              </div>
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Do you offer Cash on Delivery?</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Yes, we offer Cash on Delivery (COD) for all orders. COD charges of ₹25 
                  apply for orders below ₹999.
                </p>
              </div>
            </div>
          </div>
